			...
			<div class="row">
				<div class="col-md-6 col-xs-12">
					...
					<div class="portlet light bordered">
						...
						<form action="{{route("storeNewDocument",$projectName)}}" method="POST" enctype="multipart/form-data" >
							{{ csrf_field() }}
						...
						<div class="form-group form-md-line-input ">
							<span class="caption-subject bold uppercase">Workflow</span>
							<select class="form-control" id="discipline" name="discipline">
								...
								@foreach($disciplineList as $discipline)
									<option value="{{$discipline["id"]}}" <?php checkDiscipline($discipline["id"],old("discipline"))?>>{{ucfirst($discipline["disciplineName"])}}</option>
								@endforeach
							</select>
						</div>
						...
						<div class="form-group ">
							...
							<button class="btn blue" style="right: 25;position: absolute;top: 418px;" onclick="assignNewUser()">+ Assign User</button></div>
