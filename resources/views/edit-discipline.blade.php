                ...
                <div class="col-md-6 col-xs-12">
                    <div class="portlet light bordered">
                        ...
                        <div class="form-group form-md-line-input form-md-floating-label">
                            <input type="text" class="form-control" name="disciplineName" value="{{old('disciplineName') ?: $discipline['disciplineName']}}">
                        ...
                        <div class="form-group form-md-line-input form-md-floating-label">
                            <select class="form-control  select2me" name="initiatorName" data-placeholder="Select Initiator">
                                ...
                                <option value="{{ $user->id }}" {{ ($user->name == $discipline['initiatorName']) ?  'selected' :  '' }} >{{$user->name}}</option>
                                @endforeach
                            </select>
